...
using namespace RooFit;
  ...
  public:
    ...
    //void setBaselineHist(TString file, double iST, double iDM);
    void setBaselineHist(TString file, int iST, int iDM);
